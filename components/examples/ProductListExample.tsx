...
export default function ProductListExample() {
  ...
  const { data: productsResponse, loading, error, execute } = useProducts(filters);
              ...
              <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-200">
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-lg font-bold text-green-600">Contact for Price</span>
                    {product.rating && (
